    ...
    <main className="relative flex flex-col h-screen p-1 overflow-hidden dark:bg-light-grey">
      ...
      >
        <select
          ...
          className="w-full sm:w-40 select select-bordered join-item max-h-[20rem] min-h-[6rem]"
        >
        ...
        <div className="flex items-center justify-between w-full">
          <textarea
            ref={inputRef}
            className="w-full grow input input-bordered join-item max-h-[20rem] min-h-[6rem]"
            value={formValue}
